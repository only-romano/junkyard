...
function animateLetter(elem, i, width, height) {
  ...
  setTimeout(function(elem, left) {
    ...
    elem.style.left = left - width * 2 + height/20 + 'px';
  }, i * 100, elem, left);
}
...
<<<<<<< HEAD
    node.style.letterSpacing = '0.31em';
=======
...
function resizeBackground(height, width) {
  ...
  if (height < width * 0.56) {
    back.style.backgroundSize = '100% ' + height + 'px' ;
    back.style.WebkitBackgroundSize = '100% ' + height + 'px';
    back.style.MozBackgroundSize = '100% ' + height + 'px';
    back.style.OBackgroundSize = '100% ' + height + 'px';
  } else {
